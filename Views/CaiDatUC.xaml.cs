    ...
    public partial class CaiDatUC : UserControl
    {
        ...
        private void SaveBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                DatabaseHelper.ExecuteNonQuery(query, new object[] { minTuoi, "MinAge" });
                // Cập nhật Tuổi tối đa
                DatabaseHelper.ExecuteNonQuery(query, new object[] { maxTuoi, "MaxAge" });
                // Cập nhật Sĩ số
                DatabaseHelper.ExecuteNonQuery(query, new object[] { siSo, "MaxClassSize" });
                // Cập nhật Điểm đạt
                DatabaseHelper.ExecuteNonQuery(query, new object[] { diemDat, "PassingGrade" });
